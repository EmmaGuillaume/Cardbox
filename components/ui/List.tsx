        ...
        <>
            <div className="bg-background-800 border-background-800 flex flex-col gap-3 p-3.5 rounded-lg">
                    ...
                    {items.map((item, index) =>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{ opacity: index * 0.20, zIndex: 100 - index * 2 + 1 }}
                                ></div>
                            </div>
                    )}
                </div>
                ...
                <div className="flex flex-row items-center gap-2">
                    <Image className="rounded-full" alt={`Avatar of ${author}`} src={avatar} width={24} height={24} />
                    <span className="text-primary text-xs">Created by <span className="font-semibold">{author}</span></span>
                </div>
            </div>
        </>
    )
