...
export default function TapBar() {
    return (
        <div className="w-full h-16 px-4 bg-background-900/80 flex justify-around items-center fixed bottom-0 border-t border-background-800 backdrop-blur-lg text-primary font-krub text-xs lg:hidden">
            ...
            <Link href="/search" className="flex flex-col items-center cursor-pointer">
                <Search className="w-5 h-5" />
                <span>Rechercher</span>
            </Link>
            <Link href="/profile/1/list" className="flex flex-col items-center cursor-pointer">
                <Library className="w-5 h-5" />
                <span>Bibliothèque</span>
            </Link>
            <Link href="/profile/1/activity" className="flex flex-col items-center cursor-pointer">
